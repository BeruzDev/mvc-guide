...
//Definimos los endpoints de la aplicación junto con los metodos 
	...
	router.post('/:id', controller.create)//<-si la peticion es post, se ejecuta el metodo create del control
